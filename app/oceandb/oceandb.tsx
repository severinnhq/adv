...
export default function OceanDB() {
  ...
  }, [preset, customFrom, customTo, selectedArticle]);
  ...
  return (
    <div style={{ fontFamily: "'IBM Plex Mono', 'JetBrains Mono', monospace", background: "#0a0e1a", color: "#c8d6e5", minHeight: "100vh" }}>
      <style>{`
        ...
        .ocean-subtitle { font-size: 13px; color: #4a5568; letter-spacing: 2px; text-transform: uppercase; }
        .ocean-body { padding: 24px 32px; max-width: 1400px; margin: 0 auto; }
        ...
        .filter-btn {
          padding: 8px 18px; border-radius: 6px; border: 1px solid #1e293b;
          background: #111827; color: #94a3b8;
          font-family: 'IBM Plex Mono', monospace; font-size: 13px; font-weight: 500;
          cursor: pointer; transition: all 0.2s;
        }
        .filter-btn:hover { border-color: #2dd4bf; color: #e2e8f0; }
        .filter-btn.active { background: rgba(45, 212, 191, 0.12); border-color: #2dd4bf; color: #2dd4bf; }
        .custom-date-input {
          padding: 7px 12px; border-radius: 6px; border: 1px solid #1e293b;
          background: #111827; color: #e2e8f0;
          font-family: 'IBM Plex Mono', monospace; font-size: 13px; color-scheme: dark;
        }
        ...
        .stat-card:hover { border-color: #2dd4bf; transform: translateY(-2px); box-shadow: 0 8px 24px rgba(0,0,0,0.3); }
        .stat-card.selected { border-color: #2dd4bf; background: rgba(45, 212, 191, 0.06); }
        .stat-card.best::after {
          content: '🏆 BEST'; position: absolute; top: 12px; right: 12px;
          font-size: 10px; font-weight: 700; color: #fbbf24; letter-spacing: 1px;
        }
        .stat-count { font-family: 'Space Grotesk', sans-serif; font-size: 32px; font-weight: 700; color: #f1f5f9; margin-bottom: 6px; }
        .stat-label { font-size: 12px; color: #64748b; line-height: 1.4; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
        .stat-id { font-size: 11px; color: #374151; margin-top: 4px; }
        .stat-pct { font-size: 11px; color: #4a5568; margin-top: 2px; }
        .stat-bar { height: 4px; border-radius: 2px; background: #1e293b; margin-top: 12px; overflow: hidden; }
        ...
        .summary-box { background: #111827; border: 1px solid #1e293b; border-radius: 12px; padding: 20px 24px; flex: 1; min-width: 180px; }
        .summary-number { font-family: 'Space Grotesk', sans-serif; font-size: 36px; font-weight: 700; color: #2dd4bf; }
        .summary-label { font-size: 12px; color: #4a5568; text-transform: uppercase; letter-spacing: 1.5px; margin-top: 4px; }
        .event-table { width: 100%; border-collapse: collapse; font-size: 13px; }
        .event-table th {
          text-align: left; padding: 12px 16px; color: #4a5568;
          font-weight: 600; font-size: 11px; text-transform: uppercase; letter-spacing: 1.5px;
          border-bottom: 1px solid #1e293b; background: #0f172a;
        }
        .event-table td { padding: 10px 16px; border-bottom: 1px solid rgba(30,41,59,0.5); color: #94a3b8; }
        ...
        .page-btn {
          ...
          background: #111827; color: #94a3b8;
          font-family: 'IBM Plex Mono', monospace; font-size: 12px; cursor: pointer; transition: all 0.2s;
        }
        ...
        .clear-filter {
          font-size: 11px; color: #ef4444; cursor: pointer; padding: 4px 10px;
          border: 1px solid rgba(239,68,68,0.3); border-radius: 4px;
          background: transparent; font-family: 'IBM Plex Mono', monospace; transition: all 0.2s;
        }
        ...
        .empty-state h3 { font-family: 'Space Grotesk', sans-serif; font-size: 20px; color: #4a5568; margin-bottom: 8px; }
        .empty-state p { font-size: 13px; color: #374151; }
        .error-box {
          background: rgba(239, 68, 68, 0.08); border: 1px solid rgba(239, 68, 68, 0.3);
          border-radius: 12px; padding: 24px; text-align: center; color: #ef4444; font-size: 14px; margin-bottom: 24px;
        }
        .article-tag {
